package sg.ncs.psc.generator.util;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("sg.ncs.psc.common.translation.annotation.Translation");
                importList.add("sg.ncs.psc.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
